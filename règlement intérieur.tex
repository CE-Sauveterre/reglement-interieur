...
Tout contrat de pension signé est valable un an et reconductible par tacite reconduction. Il peut être rompu par le propriétaire à tout moment, par courrier recommandé, entraînant un préavis de \textbf{deux mois}. Durant ces deux mois, l'équidé ne peut être retiré du Centre Équestre et les pensions restent dues.

Cependant, toute exclusion d'un propriétaire du Centre Équestre, décidée par la direction pour raisons disciplinaires comme prévues à l'article 8, peut être à effet immédiat ou faire l'objet d'un préavis d'une durée décidée par la direction en sa qualité de responsable des écuries et du Centre Équestre.
