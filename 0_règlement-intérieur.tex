...
%\titleformat*{\subsection}{\centering\large\bfseries}{Article~\thesubsection :}
\titleformat{\subsection}{\centering\large\bfseries}{Article~\thesubsection~:}{.5em}{}[\vspace*{-0.3\baselineskip}%
...
\renewcommand{\notitlepageupperline}{
	...
	\begin{minipage}{\textwidth}
		...
		\begin{minipage}{0.33\textwidth}
			...
			{\color{black}\No \hspace{3em}/CES/DIR}
		\end{minipage}
	\end{minipage}
}
...
%\vspace{-30pt}
	...
	Il est à respecter par toute personne s'y trouvant : membres, stagiaires, propriétaires, personnels, clientèle\dots

	Le non-respect de ce règlement entraînera l'exclusion provisoire ou définitive du Centre Équestre, sans indemnité.
	...
	\begin{multicols}{2}
		...
		Il s'engage par ailleurs à signaler, au plus tard la veille, son absence à une activité à laquelle il se serait inscrit, pour garantir une bonne gestion de la cavalerie.
		Par ailleurs, les leçons retenues, non décommandées avant 18h00 la veille de la reprise, sont dues.
		...
		La pratique en autonomie du saut d'obstacles est interdite aux cavaliers propriétaires non titulaires du Galop 7.
		...
		Sont prioritaires les activités encadrées par le Centre Équestre, leur planning étant disponible à l'accueil.
		...
		En tout lieu et en toute circonstance, les adhérents sont tenus d'observer une attitude respectueuse empreinte de correction et de savoir-vivre vis-à-vis du personnel encadrant, des personnels, et des autres cavaliers et visiteurs.
		...
		Les jeux (balles, ballons\dots) sont interdits dans l'enceinte du Club.\par
		...
		Tout adhérent désireux de présenter une réclamation qu'il estime motivée et justifiée concernant le Centre Équestre, ses membres ou personnels, peut opérer de l'une des manières suivantes :
		\begin{itemize}
			\item
			...
			\item
			consigner sa réclamation sur le cahier prévu à l'article~\ref{subsec:observations-et-suggestions-par-les-membres}.
		\end{itemize}
		...
		\textit{\textbf{Le respect du cheval étant une règle absolue, tout mauvais traitement peut entraîner l'exclusion immédiate.}}
		...
		Les cavaliers mineurs ne sont sous la responsabilité du Centre Équestre que durant la durée de leur reprise (ou de leur balade) et durant le temps de préparation de l'équidé et le retour à l'écurie (ou en prairie), soit \textit{\textbf{une demi-heure avant}} et \textit{\textbf{une demi-heure après}}.

		En dehors des heures d'activité ainsi définies, même sur le site du Centre Équestre, \textit{\textbf{les mineurs sont sous la responsabilité de leurs parents ou de leur tuteur légal}}.
		...
		Toute balade doit être réglée avant son début, et le Centre Équestre se réserve le droit de refuser au départ d'une balade quelqu'un ne l'ayant pas réglée selon ces modalités.
		...
		Les propriétaires auront pris connaissance des \textit{Conditions Générales de prise en pension}, présenté en annexe.
		...
		Sont mis à disposition des cavaliers, dans chaque casier, au minimum un porte-selle et un porte-filet pour les petits casiers, et deux de chaque dans les grands.
