...
\begin{document}
   ...
   \begin{itemize}
      ...
      \end{enumerate}
      Tout premier règlement du montant de la prestation vaut contrat.
   \end{itemize}
   ...
   En cas de copropriété d'un équidé mis en pension, un interlocuteur privilégié a été défini parmi les copropriétaires dans le contrat de pension et ce dernier sera le seul contacté en cas d'urgence.
   Il est de la responsabilité de cet interlocuteur de prendre contact avec les autres copropriétaires.
   Le Centre Équestre ne peut être tenu pour responsable en cas de mauvaise transmission de l'information entre copropriétaires.
