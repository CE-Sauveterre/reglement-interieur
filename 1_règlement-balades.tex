...
%\thispagestyle{firstpage}
   ...
   En juillet et août, les balades à poney se font à horaires définis sur réservation.
   De durée fixe, elles se font sous encadrement du Centre Équestre, le poney étant tenu par un parent ou responsable majeur.
   Le reste du temps, les tours en main se font sous l'entière responsabilité des parents ou accompagnateurs majeurs.

   Dans tous les cas, elles se font \textbf{exclusivement au pas}, à raison d'un enfant par poney, équipé d'un casque homologué.
   ...
   Un départ en balade peut être refusé si cette condition n'est pas remplie.
   ...
   Toute balade à cheval est encadrée par le nombre d'enseignants défini par la direction, en accord avec les règlements et la législation en vigueur.
   ...
   On distingue, en balade, deux groupes distincts : les \og débutants \fg{} (toute personne non expérimentée montant à cheval pour la première fois ou seulement occasionnellement, sans niveau fédéral) et les \og confirmés \fg{} qui sont les cavaliers possédant un niveau équestre (du point de vue fédéral) et étant en capacités de trotter et galoper en toute aisance en extérieur\footnote{Galop 3 ou équivalent.}.
   ...
   Néanmoins, pour des raisons de sécurité, l'enseignant se réserve le droit, en accord avec la direction, de refuser un cavalier portant une tenue non adaptée à la pratique de l'équitation en extérieur (tongs, sac à dos, écharpe, déguisement\dots).
   ...
   Une balade est considérée comme débutée : à cheval, lorsque le groupe est à l'extérieur du manège (ou carrière) ; à poney, lorsque le poney s'engage dans le chemin de la forêt.
